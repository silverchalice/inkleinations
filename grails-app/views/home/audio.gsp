...
<html>
    ...
    <body>
        ...
        <g:each in="${audiobookInstanceList}" var="audiobook">
            <p><strong><a href="/audio/${audiobook.bookName}">${audiobook.title}</a></strong></p>
        ...
        <g:each in="${talkInstanceList}" var="talk">
            <p><strong><a href="/audio/${talk.talkName}">${talk.title}</a></strong> (${talk.name})</p>
            <p>${talk.description} (${talk.time})</p>
            <br />
        </g:each>
        <section:content for="songs" />
        <g:each in="${songInstanceList}" var="song">
            <p><strong><a href="/audio/${song.songName}">${song.title}</a></strong></p>
